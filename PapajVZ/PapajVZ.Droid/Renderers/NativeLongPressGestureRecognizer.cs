...
namespace PapajVZ.Droid.Renderers
{
	public class NativeLongPressGestureRecognizer : BaseNativeGestureRecognizer
	{
	    ...
	    private LongPressGestureRecognizer LongPressGestureRecognizer => Recognizer as LongPressGestureRecognizer;
...
//					e.IsConsumed = true;
	    ...
	    private void _longPressTapTimer_Elapsed (object sender, System.Timers.ElapsedEventArgs e)
		{
	    ...
	    private void ResetLongPressTimer (bool isActive)
		{
			...
			if (isActive) {
			    ...
			    {
			        AutoReset = false,
			        Interval = LongPressGestureRecognizer.MinimumPressDuration*1000
			    };
			    _longPressTimer.Elapsed += _longPressTapTimer_Elapsed;
